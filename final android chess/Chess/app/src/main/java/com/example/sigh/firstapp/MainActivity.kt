...
open class MainActivity: AppCompatActivity() {
                    ...
                    override fun onDataChange(dataSnapshot: DataSnapshot?) {
                        try{
                            if(dataSnapshot!!.value.toString().equals("Y")){
                                ...
                                upperTV.visibility = View.VISIBLE
                                lowerTV.visibility = View.VISIBLE
                            }
                        }catch (ex:Exception){}
                    }
    ...
    protected fun setChessBoard() {
        if(winner == -1) {
            ...
            var chessBoard = Pieces(id1, id2, btn1, btn2, player, board, ldRookNeverMoved, rdRookNeverMoved, llRookNeverMoved, rlRookNeverMoved, dKingNeverMoved, lKingNeverMoved, previousPlayer)
            chessBoard.move()
            ...
            if (chessBoard.isValidMovement()) {
                ...
                if(previousPlayer == 1){
                    ...
                    p2.text = convertToStep(id1) +"->"+convertToStep(id2)
                }
    ...
    fun opponentsMove(move: String){
        ...
        if(previousPlayer == 1){
            ...
            p1.text = convertToStep(move.split(",")[0].toInt()) +"->"+convertToStep(move.split(",")[1].toInt())
        }
    }
    ...
    fun convertToStep(id: Int): String{
