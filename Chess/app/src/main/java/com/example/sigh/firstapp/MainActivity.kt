...
open class MainActivity: AppCompatActivity() {
    ...
    protected fun setChessBoard() {
        if(winner == -1) {
            ...
            var chessBoard = Pieces(id1, id2, btn1, btn2, player, board, ldRookNeverMoved, rdRookNeverMoved, llRookNeverMoved, rlRookNeverMoved, dKingNeverMoved, lKingNeverMoved)
            chessBoard.move()
    ...
    protected fun checkWin(){
        var isLKing = false
        var isDKing = false
        var restart = findViewById(R.id.restart) as Button
